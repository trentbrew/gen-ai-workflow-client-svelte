...
<Sidebar.Menu>
  <Sidebar.MenuItem>
    <DropdownMenu.Root>
      <DropdownMenu.Trigger class="pointer-events-none">
        {#snippet child({ props })}
          <Sidebar.MenuButton
            {...props}
            size="lg"
          ...
          >
            ...
            <div class="grid flex-1 text-left text-sm leading-tight">
              ...
              <span class="truncate text-xs opacity-50">{activeTeam.plan}</span>
            </div>
      ...
      >
        ...
        {#each teams as team, index (team.name)}
          <DropdownMenu.Item onSelect={() => (activeTeam = team)} class="gap-2 p-2">
            <div class="flex size-4 items-center justify-center rounded-md border">
